  ...
  return (
    <div style={{ 
      ...
      <section style={{
        ...
        <div className="grid-2-col" style={{ maxWidth: 1200, margin: '0 auto', padding: '120px 24px 80px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
          <div>
            ...
            <h1 className="headline-font animate-in animate-delay-1" style={{
              ...
              Built Better.<br />
              Built Faster.<br />
              <span style={{ color: colors.primary }}>Built for You.</span>
            </h1>
            ...
            <div className="animate-in animate-delay-4 stats-row" style={{ display: 'flex', gap: 40 }}>
              {[
                { value: '$240K', label: 'Starting Price' },
                { value: '0%', label: 'Down Payment' },
                { value: '8 Weeks', label: 'To Move In' }
              ].map(stat => (
                <div key={stat.label}>
          ...
          <div className="hero-visual" style={{ position: 'relative' }}>
            <div className="float" style={{
              ...
              position: 'relative',
              overflow: 'hidden',
              boxShadow: `0 30px 60px ${colors.primary}40`
            }}>
              <div style={{
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 className="headline-font" style={{ fontSize: 'clamp(28px, 4vw, 42px)', marginBottom: 16 }}>
              Homes for the People Who Power Birmingham
            </h2>
            <p style={{ fontSize: 18, opacity: 0.85, maxWidth: 600, margin: '0 auto' }}>
              We build for working families earning around $65,000 a year. The people who deserve to own, not rent.
            </p>
          </div>
          
          <div className="grid-4-col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20 }}>
            {[
              { icon: '👩‍🏫', title: 'Teachers', desc: 'Shaping the next generation' },
              { icon: '👨‍⚕️', title: 'Nurses', desc: 'Caring for our community' },
              { icon: '👷', title: 'Tradespeople', desc: 'Building our city' },
              { icon: '👨‍👩‍👧‍👦', title: 'Working Families', desc: 'Growing roots here' }
            ].map(person => (
              <div key={person.title} className="hover-lift" style={{
                background: 'rgba(255,255,255,0.1)',
      ...
      <section style={{ padding: '100px 24px', background: colors.background }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2 className="headline-font" style={{ fontSize: 'clamp(28px, 4vw, 42px)', color: colors.text, marginBottom: 16 }}>
              From QR Scan to Keys in Hand
            </h2>
            <p style={{ fontSize: 18, color: colors.textLight, maxWidth: 600, margin: '0 auto' }}>
              We've eliminated the complexity. See a lot, design your home, move in 8 weeks later.
            </p>
          </div>
            ...
            {steps.map((step, idx) => (
              <div 
                ...
                style={{
                  ...
                  background: idx === activeStep ? colors.primary : 'white',
                  color: idx === activeStep ? 'white' : colors.text,
                  boxShadow: idx === activeStep ? `0 20px 40px ${colors.primary}30` : '0 4px 20px rgba(0,0,0,0.05)',
                  border: idx === activeStep ? 'none' : '1px solid rgba(0,0,0,0.04)'
                }}
              >
                <div style={{
                  width: 44,
                  height: 44,
                  borderRadius: 10,
                  background: idx === activeStep ? 'rgba(255,255,255,0.2)' : `${colors.primary}12`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontSize: 20,
      ...
      <section style={{ padding: '100px 24px', background: `linear-gradient(180deg, ${colors.backgroundAlt} 0%, ${colors.background} 100%)` }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 className="headline-font" style={{ fontSize: 'clamp(28px, 4vw, 42px)', color: colors.text }}>
              The RediHome Difference
            </h2>
          </div>
            ...
            {[
              {
                ...
                points: ['2x6 framing, not builder-grade 2x4', 'Air-tight construction', 'Closed-cell spray foam insulation', 'Low energy bills']
              },
              {
                title: 'Built Faster',
                icon: '⚡',
                color: colors.accent,
                points: ['Lots already prepared', 'Permits done in advance', '8 weeks from contract to keys', 'Move in while others wait']
              },
              {
                title: 'Built for You',
                icon: '❤️',
                color: colors.primaryLight,
                points: ['Multiple floor plans', '20+ customizations', 'Easy design process', 'Personal, not cookie-cutter']
              }
            ].map(pillar => (
              <div key={pillar.title} className="hover-lift" style={{
                ...
                <h3 className="headline-font" style={{ fontSize: 24, color: pillar.color, marginBottom: 16 }}>
                  {pillar.title}
                </h3>
      ...
      <section style={{
        ...
        <div className="grid-2-col" style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center', position: 'relative' }}>
          <div>
            ...
            <h2 className="headline-font" style={{ fontSize: 'clamp(28px, 4vw, 42px)', marginBottom: 20 }}>
              Financing That Actually Makes Sense
            </h2>
            
            <p style={{ fontSize: 17, opacity: 0.9, lineHeight: 1.7, marginBottom: 28 }}>
              Through our banking partner's Right@Home program, we've created a path to homeownership that doesn't require years of saving or perfect credit.
            </p>
            
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
                { value: '0%', label: 'Down Payment', desc: 'Keep your savings' },
                { value: 'No', label: 'PMI Required', desc: 'More in your pocket' },
                { value: '620+', label: 'Credit Score', desc: 'Real pathways' },
                { value: '~1 Week', label: 'Approval Time', desc: 'Know fast' }
              ].map(item => (
            ...
            <div style={{ marginTop: 24 }}>
              <Link href="/financing" className="btn-white">
          ...
          <div style={{
            ...
            <div className="headline-font" style={{ fontSize: 42, fontWeight: 700, color: colors.primary, marginBottom: 20 }}>
              ~$1,650<span style={{ fontSize: 18, fontWeight: 400, color: '#888' }}>/month</span>
            </div>
            
            <div style={{ borderTop: '1px solid #eee', paddingTop: 20 }}>
              {[
                { label: 'Home Price', value: '$240,000', highlight: false },
                { label: 'Down Payment', value: '$0', highlight: true },
                { label: 'PMI', value: '$0', highlight: true },
                { label: 'Energy Costs', value: 'Low', highlight: false }
              ].map(row => (
            ...
            <div style={{
              ...
              💡 If 30% of your take-home pay covers this payment, you likely qualify. Not there yet? We have resources to help.
            </div>
          </div>
        </div>
      </section>
      
      {/* Community Impact Section (replaces testimonials) */}
      <section style={{ padding: '100px 24px', background: colors.background }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 className="headline-font" style={{ fontSize: 'clamp(28px, 4vw, 42px)', color: colors.text, marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 18, color: colors.textLight, maxWidth: 700, margin: '0 auto' }}>
              RediHome develops infill lots—empty or underutilized properties in Birmingham's established neighborhoods. We're not building subdivisions at the edge of town. We're filling in the gaps where good homes are needed most.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'We transform vacant lots into beautiful homes, strengthening blocks that need investment and bringing new energy to established communities.'
              },
              {
                icon: '📈',
                title: 'Building Generational Wealth',
                desc: 'Homeownership is the #1 way working families build wealth. Every home we build is an opportunity for a family to invest in their future.'
              },
              {
                icon: '🤝',
                title: 'Strengthening Community',
                desc: 'Owner-occupied neighborhoods are safer, more stable, and more connected. We\'re helping shift rental-heavy areas to homeownership communities.'
              }
            ].map(item => (
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {['Shorter commutes to work', 'Established schools and services', 'Real neighborhood character', 'Appreciation in proven locations'].map(item => (
                  <li key={item} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, color: colors.textLight, fontSize: 15 }}>
                    <span style={{ color: colors.primary, fontWeight: 700 }}>✓</span> {item}
                  </li>
                ))}
              </ul>
            </div>
            <div className="hover-lift" style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {['Revitalizing blocks that need investment', 'Shifting renters to owners', 'Building generational wealth', 'Strengthening community roots'].map(item => (
                  <li key={item} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, opacity: 0.9, fontSize: 15 }}>
                    <span>✓</span> {item}
                  </li>
                ))}
              </ul>
