  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
      <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
        <path 
          d="M50 15L10 45V48H18V85H42V60H58V85H82V48H90V45L50 15Z" 
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div className="footer-grid" style={{ 
          ...
          <div>
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.7, maxWidth: 280 }}>
              Building affordable homeownership for Birmingham's working families. Built Better. Built Faster. Built for You.
            </p>
            <div style={{ marginTop: 20 }}>
              <div style={{ fontSize: 14, opacity: 0.9, marginBottom: 4 }}>
                <a href="mailto:sales@redihome.io" style={{ color: 'white' }}>sales@redihome.io</a>
              </div>
              <div style={{ fontSize: 14, opacity: 0.9 }}>
                <a href="tel:205-612-5445" style={{ color: 'white' }}>205-612-5445</a>
              </div>
            </div>
          </div>
...
// CTA Section Component (reusable)
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative' }}>
        <h2 className="headline-font" style={{ fontSize: 'clamp(32px, 5vw, 48px)', marginBottom: 20 }}>
          Ready to See What's Possible?
        </h2>
        <p style={{ fontSize: 17, opacity: 0.9, marginBottom: 32, lineHeight: 1.7 }}>
          Find a lot near you, scan the QR code, and design your future home. No pressure, no salespeople—just you, exploring what homeownership could look like.
        </p>
